...
<!-- According to the documentation, the osis tag should look like:

       <osis xmlns='http://www.bibletechnologies.net/2003/OSIS/namespace' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xsi:schemaLocation='http://www.bibletechnologies.net/2003/OSIS/namespace ${'$'}xsdLocation'>
     
     None of these URI's exist, and since having the line here stops the processing
     from working correctly, I've opted to drop the details.
-->
