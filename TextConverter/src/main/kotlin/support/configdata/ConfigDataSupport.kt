...
object ConfigDataSupport
{
   ...
   * comprised of the 3-character ISO code for the language all lower case,
   * followed by an underscore and then an abbreviation or very short full name
   * for the text being handled, case immaterial.
   *
   ...
   * - No underscore.
   * - Abbreviation to start with capital, and _usually_ to be caps only.
   *
