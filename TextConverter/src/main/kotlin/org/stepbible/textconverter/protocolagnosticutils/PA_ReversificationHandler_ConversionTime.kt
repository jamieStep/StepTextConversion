...
// * remote.  In particular, it was written at a time when I was not considering
// * parallel processing, and may well not fit in with the structure I rely on
// * for that -- to wit, individual books held in temporary documents.</span>
// *
// *
// *
// *
...
//      val bookNode = Dom.createTextNode(rootNode.ownerDocument, "") // $$$ This row is garbage.  I have added it so this still compiles.  Originally it was something like the row above, but I had to ditch tagName_book.
//
