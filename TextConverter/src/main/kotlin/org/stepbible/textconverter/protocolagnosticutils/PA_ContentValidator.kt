...
//    Dbg.d(dataCollectionNew.getDocument(), "b.xml")
    ...
    m_ImplicitReversificationRenumbers = PA_ReversificationHandler.instance().getImplicitRenumbers()
    m_ReversificationRowsForAllBooks = PA_ReversificationHandler.instance().getSelectedRows()
...
//    Dbg.outputDom(m_DataCollectionNew.getRootNode(bookNo)!!.ownerDocument)
    ...
    val sourceBookNumbers = listOf(bookNo)
