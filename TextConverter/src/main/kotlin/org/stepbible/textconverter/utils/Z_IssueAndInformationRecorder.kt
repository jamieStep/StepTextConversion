...
open class Z_IssueAndInformationRecorder protected constructor (fileProtocol: Z_FileProtocol)
{
  /****************************************************************************/
  /****************************************************************************/
  /**                                                                        **/
  ...
  */
  ...
  fun elidedVerse (location: RefKey, text: String) =
    report("Elided verse: $text", false, "LogInfo", location, m_ElidedVerses, null)
  ...
  fun setHasFootnotes()                             { m_RunFeatures.HasFootnotes = true }
  ...
  /****************************************************************************/
  /**
  * Outputs a summary of he features contained in the text being processed.
  *
  * @param filePath File to which to write the details.
  * @param bibleStructure
  */

  fun processFeaturesSummaryBibleStructure (filePath: String, bibleStructure: Z_BibleStructure)
  {
    if ("tbd" == (ConfigData["stepVersificationScheme"] ?: "tbd"))
      ConfigData["stepVersificationScheme"] = "v11n_" + ConfigData["stepModuleName"]

    outputBibleStructureToJson(filePath, bibleStructure)
  }


  /****************************************************************************/
  fun processFeaturesSummaryRunParameters (filePath: String)
  {
    if ("tbd" == (ConfigData["stepVersificationScheme"] ?: "tbd"))
      ConfigData["stepVersificationScheme"] = "v11n_" + ConfigData["stepModuleName"]
  ...
  /****************************************************************************/
  protected class BibleTextStructure
  {
  ...
  /****************************************************************************/
  private fun outputBibleStructureToJson (filePath: String, bibleStructure: Z_BibleStructure)
  {
  ...
  /****************************************************************************/
  private fun populateBibleDetails (bibleStructure: Z_BibleStructure)
  {
  ...
  /****************************************************************************/
  open fun populateTextFeaturesFromNode (node: Node) { throw StepExceptionShouldHaveBeenOverridden() }
  ...
  /****************************************************************************/
  protected val m_BibleTextStructure = BibleTextStructure()
  private val m_RunFeatures = RunFeatures()
  protected val m_NodeNames: MutableSet<String> = HashSet()
 }
...
/******************************************************************************/
object Osis_IssueAndInformationRecorder: Z_IssueAndInformationRecorder(Osis_FileProtocol)
{
  /****************************************************************************/
  override fun populateTextFeaturesFromNode (node: Node)
  {
    /**************************************************************************/
    ...
    when (nodeName)
    {
      "note" ->
      {
        if ("explanation" == node["type"])
          m_BibleTextStructure.HasFootnotes = true
        else if ("crossReference" == node["type"])
          m_BibleTextStructure.HasCrossReferences = true
      }

      "p" -> // When text has been converted from USX, we don't use <speaker>.  Instead we have a specially marked para.
      {
        if ("_temp_speaker" in node)
        {
      ...
      "speaker" -> // When we receive input from an external source, speaker will presumabl be marked as such.
      {
        m_BibleTextStructure.SpeakerLocations.add(m_CurrentVerseSid)
        m_BibleTextStructure.HasSpeakers = true
      }
...
/******************************************************************************/
object Usx_IssueAndInformationRecorder : Z_IssueAndInformationRecorder(Usx_FileProtocol)
{
  /****************************************************************************/
  override fun populateTextFeaturesFromNode (node: Node)
  {
    ...
    /**************************************************************************/
    val nodeName = m_FileProtocol.getExtendedNodeName(node)
    m_NodeNames.add(nodeName)
    when (nodeName)
    {
...
/*****************************************************************************/
object Osis_IssueAndInformtionRecorder: Z_IssueAndInformationRecorder(Osis_FileProtocol)
object Usx_IssueAndInformtionRecorder: Z_IssueAndInformationRecorder(Usx_FileProtocol)