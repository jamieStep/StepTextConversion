...
import org.stepbible.textconverter.support.configdata.StandardFileLocations.getTextFeaturesFilePath
import org.stepbible.textconverter.support.configdata.StandardFileLocations.getVernacularBibleStructureFilePath
...
object DataSummary
{
  ...
  */
  ...
  /****************************************************************************/
  fun outputBibleStructureToJson ()
  {
    ...
    val header = """
                 ...
                 //******************************************************************************   
                 """.trimIndent()
    outputJson(getVernacularBibleStructureFilePath(), header, m_BibleStructure)
  }
  ...
  {
    m_BibleStructure.ModuleName = ConfigData.get("stepModuleName")!!
  ...
  private fun outputTextFeaturesToJson ()
  {
    ...
    outputJson(getTextFeaturesFilePath(), header, m_TextFeatures)
  }
