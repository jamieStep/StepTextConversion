...
object ReversificationRuleEvaluator
{
  /****************************************************************************/
  /****************************************************************************/
  /**                                                                        **/
  ...
  */
  ...
  private fun lengthComparison (text: String): Boolean
  {
    ...
    for (side in sides.indices)
    {
      ...
      for (i in elts.indices)
      {
        ...
        val refs = RefCollection.rdUsx(usxifyFromStepFormat(refCollectionAsString)).getAllAsRefs()
  ...
  private fun lengthWarning (theMsg: String)
  {
    ...
    Logger.warning(msg)
    DataSummary.addReversificationIssue(msg)
  }
