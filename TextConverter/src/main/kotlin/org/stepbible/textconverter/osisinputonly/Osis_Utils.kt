...
object Osis_Utils
{
  ...
  *
  * @param scope The caller should use makeScope to create this string.
  * @return File header.
  */
  ...
  fun fileHeader (scope: String?): String
  {
    ...
    val standardComment = "\n\n" +
                          ...
                          "     StepOriginalSourceType: ${ConfigData["stepProcessingOriginalData"]!!}\n" +
                                reportableChanges + "\n" +
...
<osis>
  ...
  */
  ...
  fun makeScope (bookNumbersPossiblyUnsorted: List<Int>): String?
  {
