...
object Osis_Utils: ObjectInterface
{
  ...
  */
  ...
  fun fileHeader (bookNumbers: List<Int>): String
  {
    ...
    val userName = ConfigData["stepUserName"] ?: System.getProperty("user.name")

    val standardComment = "\n\n" +
                          "<!-- ====================================================================================================\n\n\n" +
                          "     StepSummary: OSIS generated by the STEP project (www.stepbible.org) $userName $todaysDate.\n" +
                          "     StepOriginalSourceType: ${ConfigData["calcOriginData"]!!}\n\n" +
...
<osis>
  <osisText osisIDWork='${'$'}moduleName' osisRefWork='${'$'}toLowerPublicationType' xml:lang='${'$'}languageCode' canonical='true'>
    ...
    /**************************************************************************/
    /* Fill in details in the standard header string. */
    ...
    vals["languageCode"] = ConfigData["calcLanguageCode3Char"]
    vals["moduleName"] = ConfigData["calcModuleName"]
    vals["publicationType"] = publicationType
    vals["revisionDesc"] = LocalDate.now().format(DateTimeFormatter.ofPattern("yyyy.MM.dd"))
    vals["scope"] = scope
    vals["shortCopyright"] = ConfigData["swordShortCopyright"]!!.replace("<.*?>".toRegex(), " ").replace("&copy;", "(c)")
    vals["title"] = ConfigData["stepBibleNameEnglishAsSupplied"]!!
