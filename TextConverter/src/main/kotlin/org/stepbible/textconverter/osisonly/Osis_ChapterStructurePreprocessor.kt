...
object Osis_ChapterStructurePreprocessor: ObjectInterface
{
  /****************************************************************************/
  /****************************************************************************/
  /**                                                                        **/
      ...
      with(ParallelRunning(true)) {
        run {
          dataCollection.getRootNodes().forEach { rootNode ->
            ...
            asyncable { Osis_ChapterStructurePreprocessorPerBook(dataCollection.getFileProtocol()).processRootNode(rootNode) }
          } // forEach
        } // run
      } // with
    } // withProcessingBook
...
/******************************************************************************/
private class Osis_ChapterStructurePreprocessorPerBook (val m_FileProtocol: X_FileProtocol)
{
  /****************************************************************************/
  /****************************************************************************/
  /**                                                                        **/
