...
object TextConverterProcessorUsxToEnhancedUsx2 : TextConverterProcessorBase()
  ...
  */
  ...
  /****************************************************************************/
  /* On RTL texts, we have to force things to verse per line because otherwise
     things are rendered in the wrong order.  We may also have been told to
     force verse-per-line regardless. */
