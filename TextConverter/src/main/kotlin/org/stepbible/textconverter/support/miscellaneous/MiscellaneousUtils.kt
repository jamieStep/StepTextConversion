...
import org.stepbible.textconverter.C_JarFileName
...
//  *
//  * !!! This doesn't seem to work when running the JAR from the command line.
//  * Or more accurately, getReflections doesn't seem to work.
//  *
//  * @param baseClass Base class or interface.
//  * @return List of subtypes.
//  */
//
//  fun getSubtypes_DONT_USE_ME (baseClass: Class<*>): List<Class<*>>
//  {
//    val reflections = getReflections(baseClass.getPackage().name, Scanners.SubTypes)
//    println(reflections.getSubTypesOf(baseClass).toList().size)
...
//  }
  ...
  */
  ...
  fun processRegexes (regexes: List<Pair<Regex, String>> , inputText: String): String
  {
    if (regexes.isEmpty())
      return inputText
    ...
    regexes.forEach {
      revisedText = revisedText.replace(it.first, it.second)
    }
...
//    val res = Reflections(packageName, Scanners.SubTypes)
