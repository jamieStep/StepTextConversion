...
object TranslatableFixedText
{
  ...
  */
  ...
  private val m_VernacularCode: String = ConfigData["stepLanguageCode3Char"] ?: throw StepException("Initialising TranslatableFixedText too early.") // The language code for the text being processed.
  ...
  */
  ...
  private fun getEnglish (key: String) = m_English[key] ?: throw StepException("Failed to find English message associated with $key.")
