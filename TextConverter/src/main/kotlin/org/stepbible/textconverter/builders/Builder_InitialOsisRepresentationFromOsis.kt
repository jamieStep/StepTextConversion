...
object Builder_InitialOsisRepresentationFromOsis: Builder ()
{
  ...
  override fun doIt ()
  {
    ...
    {
      var retainedBooks = 0
      Rpt.report(level = 1, "Filtering for books selected for processing.")
    ...
    Rpt.report(level = 1, "Changing div:chapter nodes into <chapter>.")
    ...
    PA_BasicVerseEndInserter.process(doc, Osis_FileProtocol)
