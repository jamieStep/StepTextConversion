...
object TextConverterProcessorReversification: TextConverterProcessorBase ()
{
  ...
  {
      return "none" != ConfigData.get("stepReversificationType")!!.lowercase()
  }
  ...
  */
  ...
  {
     SharedData.SpecialFeatures.addSpecialFeature("Reversification type", ConfigData.get("stepReversificationType")!!)
     m_FootnoteCalloutGenerator = MarkerHandlerFactory.createMarkerHandler(MarkerHandlerFactory.Type.FixedCharacter, ConfigData.get("stepExplanationCallout")!!)
  ...
  {
     when (ConfigData.get("stepReversificationType"))
     {
