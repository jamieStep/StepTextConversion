...
*
* - **[ConfigDataSupport]** provides facilities for debugging and checking
*   configuration data.
*
...
*
* - **[TranslatableFixedText]** interacts with the configuration data to obtain
*   vernacular translations of the kinds of fixed text used in standard
*   footnotes, etc.
*
*
*
