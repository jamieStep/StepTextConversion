...
abstract class RefBase
{
  ...
  companion object
  {
    ...
    /**************************************************************************/
    /* During processing it is convenient to introduce a dummy verse at the end
       of each chapter with an artificially high number, so that any verses
       which need to be inserted can definitely be inserted before *something*,
       even if they actually come at the end of the chapter. */
    ...
    /**************************************************************************/
    /**
     * The multiplier used to combine the individual elements into a single
     * RefKey.
     */
     ...
     * and a subverse of that verse are regarded as consecutive; and two
     * subverses of the same verse are regarded as consecutive.  Items are
     * regarded as consecutive only if they are in the same chapter.  If both
     * refKeys are the same, they are not regarded as consecutive.
     *
    ...
    /**************************************************************************/
    /**
    * Gets the Z_BibleStructure instance which can be used to determine things
    * like how many verses there are in a range which runs across a chapter
    * boundary.
    *
    * @return Z_BibleStructure instance.
    */

    fun getBibleStructure () = m_BibleStructure
